...
export const IndiaLogo = (props: svgProps) => (
  <svg {...props} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <path
      style={{ fill: '#FAB446' }}
...
v-73.471H0V385.379z"
    ...
    <g>
      <path
        style={{ fill: '#41479B' }}
        d="M256,303.448c-26.164,0-47.448-21.284-47.448-47.448s21.284-47.448,47.448-47.448
 ...
 "
      ...
      <polygon
        style={{ fill: '#41479B' }}
        points="256.309,256.746 244.207,263.252 216.551,273.214 215.933,271.723 242.534,259.211 
 255.691,255.254 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="256.309,256.746 269.466,252.789 296.067,240.277 295.449,238.786 267.793,248.748 
 255.691,255.254 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.254,256.309 248.748,244.207 238.786,216.551 240.277,215.933 252.789,242.534 
 256.746,255.691 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.254,256.309 259.211,269.466 271.723,296.067 273.214,295.449 263.252,267.793 
 256.746,255.691 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.691,256.746 242.534,252.789 215.933,240.277 216.551,238.786 244.207,248.748 
 256.309,255.254 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.691,256.746 267.793,263.252 295.449,273.214 296.067,271.723 269.466,259.211 
 256.309,255.254 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.254,255.691 259.211,242.534 271.723,215.933 273.214,216.551 263.252,244.207 
 256.746,256.309 	"
      />
      <polygon
        style={{ fill: '#41479B' }}
        points="255.254,255.691 248.748,267.793 238.786,295.449 240.277,296.067 252.789,269.466 
 256.746,256.309 	"
      />
    </g>
